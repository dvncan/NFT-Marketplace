    ...
    ReentrancyGuard
{
    ...
    IERC721 _hexicanContract; // 0x9a8C5DA383f3B6a4d07Fb9fDEF3ac54044e5e6bE
    ...
    function setHexicanContract(
        ...
        _hexicanContract = IERC721(newHexicanAddress);
    }
    ...
    function hexicanNoLongerForSale(uint hexicanIndex) public nonReentrant {
        if (hexicanIndex >= 5555) revert("token index not valid");
        if (_hexicanContract.ownerOf(hexicanIndex) != msg.sender)
    ...
    function buyHexican(
        ...
        if (seller != _hexicanContract.ownerOf(hexicanIndex))
        ...
        _hexicanContract.safeTransferFrom(seller, msg.sender, hexicanIndex);
    ...
    function acceptBidForHexican(
        ...
        _hexicanContract.safeTransferFrom(msg.sender, bidder, hexicanIndex);
